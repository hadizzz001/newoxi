                              ...
                              <td className="product-name-area" style={{ display: "flex", alignItems: "center" }}>
                                ...
                                <div className="product-image">
                                  <div className="wfacp-pro-thumb">
                                    ...
                                    <img src={obj.images[0]} width={50} height={50} alt={obj.title} />
                                  </div>
                                </div>
                                                          ...
                                                          <div className="wfacp_order_summary_item_total">
                                                            <span className="woocommerce-Price-amount amount">
                                                              <bdi>
                                                                ...
                                                                {obj.type === 'collection' && obj.selectedSize ? obj.color.find(c => c.color === obj.selectedColor)?.sizes.find(s => s.size === obj.selectedSize)?.price * (localQuantities[obj._id]) : obj.price * (localQuantities[obj._id] || 1)}
