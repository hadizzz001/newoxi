            ...
            <section className="SiteFooter__wrapper" id="footer">
                    ...
                    >
                        <ul>
                            ...
                            <li>
                                <a
                                    target="_blank"
                                    href="https://www.instagram.com/oxi.nab"
                                    data-auto-id="true"
                                    id="page-footer-http-www-instagram-com-bellroy-1"
                                >
                                    <svg
              ...
              C35.3,13.3,35.3,13.3,35.3,13.3z"
                            ...
                            <li>
                                <a
                                    target="_blank"
                                    href="https://www.facebook.com/oxinab.medical"
                                    data-auto-id="true"
                        ...
                        <div className="text">
                            ...
                            <div className="column">
                                <span className="copyright myGray">
                                    All rights reserved © {(new Date().getFullYear())} Oxinab
                                </span>
                            </div>
                        </div>
                    </div>
